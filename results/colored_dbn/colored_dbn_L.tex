...
\filldraw[fill=c1,rounded corners]  (0.8,-0.5) rectangle (2.2,+0.5);
\filldraw[fill=c1,rounded corners]  (2.8,-0.5) rectangle (4.2,+0.5);
...
\fill (5,0) circle (0.) node[below=1cm] {\relsize{+5}{\textbf{g}}};
\draw[thick] (0,0) -- (1,0);
\draw[thick] (1,0) -- (2,0);
\draw[thick] (2,0) -- (3,0);
\draw[thick] (3,0) -- (4,0);
...
\draw[very thick] (4,0) arc                 (0:180:1.5);
\filldraw[fill=c0,rounded corners]  (-0.2,-0.5) rectangle (1.2,+0.5);
\filldraw[fill=c0,rounded corners]  (1.8,-0.5) rectangle (3.2,+0.5);
\filldraw[fill=c1,rounded corners]  (0.8,-0.5) rectangle (2.2,+0.5);
\filldraw[fill=c1,rounded corners]  (2.8,-0.5) rectangle (4.2,+0.5);

...
$$ A =\min_{ e,f,h } \left( \colorbox{c0}{$C_{\boxtimes}$}[e,f,h,i]+B[a,h,e,f]\right) $$
$$ B\left[ a,e,f,h \right] =\min_{ b,d } \left( C[b,d,h,f]+\colorbox{c3}{$C_{\boxtimes}$}[a,b,d,e]\right) $$
$$ C\left[ b,d,f,h \right] =\min_{ c,g } \left( \colorbox{c1}{$C_{\boxtimes}$}[c,d,g,h]+\colorbox{c2}{$C_{\boxtimes}$}[b,c,f,g]\right) $$
\end{document}

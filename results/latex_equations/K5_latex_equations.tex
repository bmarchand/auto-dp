...
$$ A =\min_{ b,d,f,g,i } \left( B[d,f,a,i]+\colorbox{c4}{$C_{\boxtimes}$}[a,b,f,g]+D[d,g,i,b]\right) $$
$$ B\left[ a,d,f,i \right] =\min_{ e,j } \left( \colorbox{c3}{$C_{\boxtimes}$}[d,e,i,j]+C[f,j,e,a]\right) $$
$$ C\left[ a,e,f,j \right] =\min_{  } \left( \colorbox{c2}{$C_{\boxtimes}$}[e,f,j,k]\right) $$

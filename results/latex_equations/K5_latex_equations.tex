...
$$ A =\min_{ b,d,f,g,i } \left( B[f,d,i,a]+\colorbox{c4}{$C_{\boxtimes}$}[a,b,f,g]+D[g,b,i,d]\right) $$
$$ B\left[ a,d,f,i \right] =\min_{ e,j } \left( \colorbox{c3}{$C_{\boxtimes}$}[d,e,i,j]+C[f,a,e,j]\right) $$

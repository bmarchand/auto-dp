...
$$ A =\min_{ e,f,j } \left( B[e,a,f,j]+\colorbox{c2}{$C_{\boxtimes}$}[e,f,j,k]\right) $$
$$ B\left[ a,e,f,j \right] =\min_{ d,i } \left( C[i,d,a,f]+\colorbox{c3}{$C_{\boxtimes}$}[d,e,i,j]\right) $$
$$ C\left[ a,d,f,i \right] =\min_{ b,g } \left( \colorbox{c4}{$C_{\boxtimes}$}[a,b,f,g]+D[g,i,d,b]\right) $$

...
$$ A =\min_{ d } \left( \colorbox{c0}{$B$}[d,g\mid d,a]\right) $$
$$ \colorbox{c0}{$B$}' \left[d,g \mid  d',a \right] =  \min\begin{cases}\colorbox{c0}{$B$}'[ d , g-1\mid d',a ], &\text{if } g-1 ,\notin\{ d , d',a \} \\\colorbox{c0}{$B$}[ d+1 , g-1\mid d',a ]+\Delta G(d,g) &\text{if } \{ d+1 , g-1 \}\cap \{ d',a \}=\emptyset\end{cases}$$
$$ \colorbox{c0}{$B$} \left[d,g \mid  d',a \right] =  \min\begin{cases}\colorbox{c0}{$B$}[ d+1 , g\mid d',a ], &\text{if } d+1 \notin\{ g , d',a \} \\\colorbox{c0}{$B$}'[ d , g-1\mid d',a ], &\text{if } g-1 ,\notin\{ d , d',a \} \\\colorbox{c0}{$B$}[ d+1 , g-1\mid d',a ]+\Delta G(d,g) &\text{if } \{ d+1 , g-1 \}\cap \{ d',a \}=\emptyset,\\\colorbox{c1}{$C$}[d',a\mid g,d]\end{cases}$$

...
$$ A =\min_{ d } \left( \colorbox{c0}{$B$}[g,d|d,a]\right) $$
$$ \colorbox{c0}{$B$}' \left[g,d | d',a \right] =  \min\begin{cases}\colorbox{c0}{$B$}'[ g , d-1|d',a ], &\text{if } d-1 ,\notin\{ g , d',a \} \\\colorbox{c0}{$B$}[ g+1 , d-1|d',a ]+\Delta G(g,d) &\text{if } \{ g+1 , d-1 \}\cap \{ d',a \}=\emptyset\end{cases}$$
$$ \colorbox{c0}{$B$} \left[g,d | d',a \right] =  \min\begin{cases}\colorbox{c0}{$B$}[ g+1 , d|d',a ], &\text{if } g+1 \notin\{ d , d',a \} \\\colorbox{c0}{$B$}'[ g , d-1|d',a ], &\text{if } d-1 ,\notin\{ g , d',a \} \\\colorbox{c0}{$B$}[ g+1 , d-1|d',a ]+\Delta G(g,d) &\text{if } \{ g+1 , d-1 \}\cap \{ d',a \}=\emptyset,\\\colorbox{c1}{$C$}[d',a|13,25]\end{cases}$$

...
$$ A =\min_{ e,f,g,h,i,j } \left( \colorbox{c4}{$B$}[e,a|j,i,g,f]+D[h,a,g,j]+\colorbox{c3}{$C_{\boxtimes}$}[e,f,h,i]\right) $$
$$ \colorbox{c4}{$B$}' \left[e,a | j,i,g,f \right] =  \min\begin{cases}\colorbox{c4}{$B$}'[ e+1 , a|j,i,g,f ], &\text{if } e+1 \notin\{ a , j,i,g,f \} \\\end{cases}$$
$$ \colorbox{c4}{$B$} \left[e,a | j,i,g,f \right] =  \min\begin{cases}\colorbox{c4}{$B$}[ e , a-1|j,i,g,f ], &\text{if } a-1 ,\notin\{ e , j,i,g,f \} \\\colorbox{c4}{$B$}'[ e+1 , a|j,i,g,f ], &\text{if } e+1 \notin\{ a , j,i,g,f \} \\\colorbox{c4}{$B$}[ e+1 , a-1|j,i,g,f ]+\Delta G(e,a) &\text{if } \{ e+1 , a-1 \}\cap \{ j,i,g,f \}=\emptyset,\\C[1,g,i,f,17,j]\end{cases}$$

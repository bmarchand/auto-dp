...
$$ A =\min_{ g,h,j } \left( B[g,j,a,h]+\colorbox{c0}{$C_{\boxtimes}$}[g,h,j,k]\right) $$
$$ B\left[ a,g,h,j \right] =\min_{ e,f,i } \left( \colorbox{c4}{$C$}[e,a\mid g,j,f,i]+\colorbox{c3}{$C_{\boxtimes}$}[e,f,h,i]\right) $$
$$ \colorbox{c4}{$C$}' \left[e,a \mid  g,j,f,i \right] =  \min\begin{cases}\colorbox{c4}{$C$}'[ e , a-1\mid g,j,f,i ], &\text{if } a-1 ,\notin\{ e , g,j,f,i \} \\\colorbox{c4}{$C$}[ e+1 , a-1\mid g,j,f,i ]+\Delta G(e,a) &\text{if } \{ e+1 , a-1 \}\cap \{ g,j,f,i \}=\emptyset\end{cases}$$
$$ \colorbox{c4}{$C$} \left[e,a \mid  g,j,f,i \right] =  \min\begin{cases}\colorbox{c4}{$C$}[ e+1 , a\mid g,j,f,i ], &\text{if } e+1 \notin\{ a , g,j,f,i \} \\\colorbox{c4}{$C$}'[ e , a-1\mid g,j,f,i ], &\text{if } a-1 ,\notin\{ e , g,j,f,i \} \\\colorbox{c4}{$C$}[ e+1 , a-1\mid g,j,f,i ]+\Delta G(e,a) &\text{if } \{ e+1 , a-1 \}\cap \{ g,j,f,i \}=\emptyset,\\D[i,g,a,e,j,f]\end{cases}$$

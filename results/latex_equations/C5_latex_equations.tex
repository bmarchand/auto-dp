...
$$ A =\min_{ g,h,j } \left( B[g,h,a,j]+\colorbox{c0}{$C_{\boxtimes}$}[g,h,j,k]\right) $$
$$ B\left[ a,g,h,j \right] =\min_{ e,f,i } \left( \colorbox{c4}{$C$}[a,e|g,i,f,j]+\colorbox{c3}{$C_{\boxtimes}$}[e,f,h,i]\right) $$
$$ \colorbox{c4}{$C$}' \left[a,e | g,i,f,j \right] =  \min\begin{cases}\colorbox{c4}{$C$}'[ a , e-1|g,i,f,j ], &\text{if } e-1 ,\notin\{ a , g,i,f,j \} \\\colorbox{c4}{$C$}[ a+1 , e-1|g,i,f,j ]+\Delta G(a,e) &\text{if } \{ a+1 , e-1 \}\cap \{ g,i,f,j \}=\emptyset\end{cases}$$
$$ \colorbox{c4}{$C$} \left[a,e | g,i,f,j \right] =  \min\begin{cases}\colorbox{c4}{$C$}[ a+1 , e|g,i,f,j ], &\text{if } a+1 \notin\{ e , g,i,f,j \} \\\colorbox{c4}{$C$}'[ a , e-1|g,i,f,j ], &\text{if } e-1 ,\notin\{ a , g,i,f,j \} \\\colorbox{c4}{$C$}[ a+1 , e-1|g,i,f,j ]+\Delta G(a,e) &\text{if } \{ a+1 , e-1 \}\cap \{ g,i,f,j \}=\emptyset,\\D[1,i,f,17,g,j]\end{cases}$$

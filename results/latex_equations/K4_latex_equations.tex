...
$$ A =\min_{ b,c,e,f,g } \left( B[g,e,c,a]+\colorbox{c0}{$C_{\boxtimes}$}[a,b,e,f]+\colorbox{c2}{$C_{\boxtimes}$}[b,c,f,g]\right) $$
$$ B\left[ a,c,e,g \right] =\min_{ d,h } \left( C[d,h,e,a]+\colorbox{c3}{$C_{\boxtimes}$}[c,d,g,h]\right) $$
$$ C\left[ a,d,e,h \right] =\min_{  } \left( \colorbox{c1}{$C_{\boxtimes}$}[d,e,h,i]\right) $$
\end{document}
